...
def pad_sequences(data, max_length):
    ...
    for sentence, labels in data:
        ...
        ret.append(((sentence + [zero_vector for _ in xrange(max_length)])[:max_length],
                    (labels + [zero_label for _ in xrange(max_length)])[:max_length],
                    [i < len(sentence) for i in xrange(max_length)]))
        ### END YOUR CODE ###
    return ret
